...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/House/NewShareHouse/index'),
        meta: { title: '共享房源', hasCache: true }
      },
      {
        path: 'CommunityList',
        name: 'CommunityList',
      ...
      },
      {
        path: 'NearHouseList',
        name: 'NearHouseList',
        component: () => import('@/views/House/NearHouseList/index'),
        meta: { title: '附近房源', hidden: true }
      },
      {
        path: 'HouseInfo',
        name: 'HouseInfo',
      ...
      //   path: 'DataExport',
      //   name: 'DataExport',
      //   component: () => import('@/views/House/DataExport'),
      //   meta: { title: '数据导出', hasCache: true }
      // },
      {
        path: 'CostReturn',
        name: 'CostReturn',
        component: () => import('@/views/House/CostReturn'),
        meta: { title: '费用报销', hasCache: true }
      },
      {
        path: 'DataExport',
        name: 'DataExport',
        component: () => import('@/views/House/TodayRecommendHouse'),
        meta: { title: '今日推荐房源', hasCache: true }
      },
      {
        ...
        component: () =>
          import(
            '@/views/House/CostReturn/ReimburseDetail'
          ),
        meta: { title: '报销详情', hasCache: true, hidden: true }
      }
      // {
      //   path: 'ItemManage',
      //   name: 'ItemManage',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'AgreeIndex',
        name: 'OwnerAgreeIndex',
        component: () => import('@/views/Owner/statementOrAgree/AgreeIndex'),
        meta: {
          title: '合同解除同意书',
          markTitle: '合同解除同意书',
          hasCache: true
      ...
      {
        path: 'statementIndex',
        name: 'OwnerstatementIndex',
        component: () => import('@/views/Owner/statementOrAgree/statementIndex'),
        meta: {
          title: '同意免租声明书',
          markTitle: '同意免租声明书',
          hasCache: true
  ...
  {
    path: '/MagicDepartment',
    component: Layout,
    redirect: '/MagicDepartment',
    name: 'MagicDepartment',
    meta: { title: '魔法部', icon: 'icon-icon-mofangbu', menu: 2 },
    children: [
      {
        path: '',
        name: 'Magic',
        component: () => import('@/views/magicDepartment/index'),
        meta: { title: '魔法部', hasCache: true },
        children: []
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '未收账单', hasCache: true }
      },
      {
        path: 'contractAccount',
        name: 'contractAccount',
        component: () => import('@/views/Finance/ContractAccount/index'),
        meta: { title: '合同调帐' }
      },
      {
        path: 'AccountManage',
      ...
      },
      {
        ...
        component: () => import('@/views/Finance/ReimbursementApproval/index'),
        meta: { title: '报销单审批', hasCache: true }
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'UploadList',
        name: 'UploadList',
        component: () => import('@/views/System/UploadList/index'),
        meta: { title: '上传数据列表' }
      },
      {
        path: 'AddCompanyInfo',
  ...
  },
  {
    path: '/Export',
    component: Layout,
    redirect: '/Export/ExportApplyList',
    name: 'Export',
    meta: { title: '导出', icon: 'icon-cloud-cloud1' },
    children: [
      {
        path: 'ExportApplyList',
        name: 'ExportApplyList',
        component: () => import('@/views/Export/ExportApplyList'),
        meta: { title: '数据导出列表', hasCache: false }
      },
      {
        path: 'ExportApprovalList',
        name: 'ExportApprovalList',
        component: () => import('@/views/Export/ExportApprovalList'),
        meta: { title: '导出审核列表', hasCache: true }
      },
      {
        path: 'ExportReAuditList',
        name: 'ExportReAuditList',
        component: () => import('@/views/Export/ExportApprovalList'),
        meta: { title: '导出复核列表', hasCache: true }
      },
      {
        path: 'ExportAuditDetail',
        name: 'ExportAuditDetail',
        component: () => import('@/views/Export/ExportApprovalList/AuditDetail'),
        meta: { title: '导出审核详情', hasCache: true, hidden: true }
      },
      {
        path: 'ReceiveComfirmation',
        name: 'ReceiveComfirmation',
        component: () =>
          import('@/views/Export/ReceiveComfirmation'),
        meta: { title: '接收确认函', hasCache: true, hidden: true }
      }
    ]
  },
  {
