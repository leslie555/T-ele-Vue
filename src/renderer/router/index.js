  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import('@/views/House/ShareHouseDetail/index'),
      ...
      },
      {
        ...
        component: () => import('@/views/FixPurchase/FixToApply/FixSalesman/index'),
        meta: { title: '装修申请' }
      },
      {
        path: 'HouseConfig',
      ...
      },
      {
        ...
        name: 'CompleteHouse',
        component: () =>
        import('@/views/House/CompleteHouse/index'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Owner/EditContract/edit'),
          meta: {
            title: '修改合同',
            markTitle: '修改业主合同',
            hasCache: true,
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Owner/ContractList/index'),
        meta: {
          title: '合同列表',
          hasCache: true,
          markTitle: '业主合同列表'
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Owner/ContractDetail/index'),
        meta: {
          title: '业主合同详情',
          hasCache: true,
          hidden: true
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Owner/ContractSign/index_old'),
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Owner/ContractPreview/index'),
        ...
        children: [
          {
            ...
            component: () => import('@/views/Examine/ContractLandlordList/index'),
            meta: { markTitle: '监察部', title: '业主合同', hidden: true, routerKey: 'HomePageExamine', rootKey: 'Examine' }
          },
          {
            path: 'TenantContract',
            name: 'ContractTenantList',
            component: () => import('@/views/Examine/ContractTenantList/index'),
            meta: { markTitle: '监察部', title: '租客合同', hidden: true, routerKey: 'HomePageExamine', rootKey: 'Examine' }
          },
          {
            path: 'HouseResources',
            name: 'HouseResourcesList',
            component: () => import('@/views/Examine/HouseResources/index'),
            meta: { markTitle: '监察部', title: '房源', hidden: true, routerKey: 'HomePageExamine', rootKey: 'Examine' }
          },
          {
            path: 'Finance',
            name: 'FinanceList',
            component: () => import('@/views/Examine/Finance/index'),
            meta: { markTitle: '监察部', title: '财务', hidden: true, routerKey: 'HomePageExamine', rootKey: 'Examine' }
          }
        ]
      }
    ]
    ...
    children: [
      {
        path: 'FixPaper',
        name: 'FixPaperList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/FixPaper/index'),
        meta: { title: '装修单', hasCache: true }
      },
      {
        path: 'PurchasePaper',
        name: 'PurchasePaperList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/PurchasePaper/index'),
        meta: { title: '采购单', hasCache: true }
      },
      {
        path: 'FixPurchaseDepartment',
        name: 'FixPurchaseDepartmentList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/FixPurchaseDepartment/index'),
      ...
      },
      {
        ...
        component: () =>
          import('@/views/FixPurchase/PurchaseDepartment/FixPurchaseDepartment/detail'),
        meta: { title: '详情', hasCache: true, hidden: true }
      },
      {
        path: 'FixPurchaseDepartmentSurvey',
        name: 'FixPurchaseDepartmentSurvey',
        component: () =>
          import('@/views/FixPurchase/PurchaseDepartment/FixPurchaseDepartment/surver'),
        meta: { title: '勘察', hasCache: true, hidden: true }
      },
      {
        path: 'StoreHouse',
        name: 'StoreHouseList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/StoreHouse/index'),
        meta: { title: '库房', hasCache: true }
      },
      {
        path: 'FixApplyConfig',
        name: 'FixApplyConfigList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/FixApplyConfig/index'),
        meta: { title: '装修申请项目配置', hasCache: true }
      },
      {
        path: 'SupplyConfig',
        name: 'SupplyConfigList',
        component: () => import('@/views/FixPurchase/PurchaseDepartment/SupplyConfig/index'),
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/Tenant/EditContract/add'),
        meta: {
          title: '新增合同',
          markTitle: '新增租客合同',
          hasCache: true
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Tenant/EditContract/edit'),
        meta: {
          title: '修改合同',
          markTitle: '修改租客合同',
          hasCache: true,
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Tenant/ContractList/index'),
        meta: {
          title: '合同列表',
          hasCache: true,
          markTitle: '租客合同列表'
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Tenant/ContractDetail/index'),
        meta: {
          title: '租客合同详情',
          hasCache: true,
          hidden: true
      ...
      },
      {
        ...
        name: 'ReserveList',
        component: () =>
          import('@/views/Tenant/ReserveList/index'),
    ...
    children: [
      {
        ...
        name: 'PaymentBill',
        component: () =>
          import('@/views/Finance/PaymentBill/index'),
      ...
      // },
      {
        ...
        name: 'BookKeeping',
        component: () =>
          import('@/views/Finance/BookKeeping/index'),
      ...
      // },
      {
        ...
        name: 'AccountManage',
        component: () =>
          import('@/views/Finance/AccountManage/index'),
      ...
      },
      {
        ...
        component: () =>
          import(
            '@/views/Finance/AccountManage/pages/AccountDetail'
            ),
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Finance/FinancialConfig/index'),
      ...
      },
      {
        ...
        name: 'FinanceTax',
        component: () =>
          import('@/views/Finance/FinanceTax/index'),
    ...
    children: [
      {
        ...
        name: 'CompanyInfo',
        component: () =>
          import('@/views/Admin/CompanyInfo/index'),
    ...
    children: [
      {
        ...
        name: 'UserInfo',
        component: () =>
          import('@/views/UserCenter/UserInfo/index'),
      ...
      },
      {
        ...
        component: () =>
          import('@/views/House/HouseCollection/index'),
        meta: {
          title: '我的收藏',
          icon: 'example',
          hidden: true,
      ...
      },
      {
        ...
        name: 'OperationLog',
        component: () =>
          import('@/views/UserCenter/OperationLog/index'),
        meta: {
          title: '操作日志',
          icon: 'example',
          hidden: true,
      ...
      },
      {
        ...
        name: 'MsgCenter',
        component: () =>
          import('@/views/UserCenter/MsgCenter/index'),
    ...
    children: [
      {
        ...
        name: 'RepairList',
        component: () =>
          import('@/views/Service/RepairList/index'),
      ...
      },
      {
        ...
        component: () =>
          import(
            '@/views/Service/WaterAndelectricityReading/index'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            '@/views/Service/MeterReadingConfiguration/index'
            ),
    ...
    children: [
      {
        ...
        name: 'CalculateInfo',
        component: () =>
          import('@/views/Calculate/CalculateInfo/index'),
      ...
      },
      {
        ...
        name: 'Calculation',
        component: () =>
          import('@/views/Calculate/Calculation/index'),
      ...
      },
      {
        ...
        name: 'PriceConfig',
        component: () =>
          import('@/views/Calculate/PriceConfig/index'),
        meta: { title: '测算价格配置' }
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'ApprovalConfig',
        component: () =>
          import('@/views/approval/ApprovalConfig/index'),
        meta: { title: '审批配置' }
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'RoleManage',
        component: () =>
          import('@/views/System/RoleManage/index'),
      ...
      },
      {
        ...
        component: () =>
          import('@/views/System/DepartmentManage/index'),
      ...
      },
      {
        ...
        name: 'CompanyManage',
        component: () =>
          import('@/views/System/CompanyManage/index'),
      ...
      },
      {
        ...
        name: 'StaffManage',
        component: () =>
          import('@/views/System/StaffManage/index'),
        meta: { title: '员工管理' }
      },
      {
        path: 'AddCompanyInfo',
        name: 'AddCompanyInfo',
        component: () =>
          import('@/views/System/AddCompany/index'),
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'Expiration',
            component: () =>
              import('@/views/Report/Expiration/index'),
          ...
          },
          {
            ...
            name: 'OwnerExpires',
            component: () =>
              import('@/views/Report/OwnerExpires/index'),
          ...
          },
          {
            ...
            name: 'OwnerPayment',
            component: () =>
              import('@/views/Report/OwnerPayment/index'),
          ...
          },
          {
            ...
            name: 'CashFlow',
            component: () =>
              import('@/views/Report/CashFlow/index'),
          ...
          },
          {
            ...
            component: () =>
              import(
                '@/views/Report/RentCollectionOverdue/index'
                ),
          ...
          },
          {
            ...
            name: 'HuiStaging',
            component: () =>
              import('@/views/Report/HuiStaging/index'),
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'VacantReport',
            component: () =>
              import('@/views/Report/VacantReport/index'),
          ...
          },
          {
            ...
            name: 'OtherReports',
            component: () =>
              import('@/views/Report/OtherReports/index'),
