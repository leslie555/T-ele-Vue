...
<script>
    ...
    import { ShowPurchasingOrderDetails, ShowAllSupplierCategory, ShowRenovationProject, AddPurchasingOrderDetails, UpdatePurchasingOrderDetails, DelPurchasingOrderDetails } from '@/api/purchase'
  export default {
    name: 'ItemFitment',
    props: ['KeyID'],
    data() {
