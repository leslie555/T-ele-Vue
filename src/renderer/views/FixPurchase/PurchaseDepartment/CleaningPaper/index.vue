...
import designate from '../../RepairBill/components/designate'
...
export default {
  ...
  methods: {
    ...
    filterTableDataItem(item) {
      ...
      switch (item.State) {
        case 2: itemChooseStatus = ['Detail', 'Assgined', 'Qrcode']; break
        case 3: itemChooseStatus = ['Detail', 'Complete']; break
        case 5: itemChooseStatus = ['Detail', 'Complete']; break
        case 6: itemChooseStatus = ['Detail', 'Complete']; break
