      ...
      <div class="app-container">
          <div class="panel" v-loading="detailLoading">
                <div class="leftWidth">
                    ...
                    <div class="TopConList">
                        ...
                        <div class="conList">
                            ...
                            <div class="detail-conList">
                                <p>业务员：</p>
                                <p>{{ detailsList.UserName }}{{ detailsList.Phone }}</p>
                            </div>
                            <div class="detail-conList">
                                <p>租客：</p>
                                <p>{{ detailsList.TenName }}{{ detailsList.TenPhone  }}</p>
                            </div>
                        </div>
                        <div class="conList">
                            <div class="detail-conList">
                        ...
                        <div class="conList">
                            <div class="detail-conList">
                                <p>保洁内容：</p>
                                <p>{{ $dateFormat(detailsList.CleaningContent) }}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="leftWidth">
                    <div class="TopConList">
                        <div class="conList">
                            <div class="detail-conList">
                                <p>保洁人员：</p>
                                <p>{{ detailsList.CleaningEmpName }}</p>
                            </div>
                            <div class="detail-conList">
                                <p>完成时间：</p>
                ...
                <div class="verticalStep">
                    <div  class="stepList" v-for="(item, key) in detailsList.RenovationPlanTrack" :key = key>
                        <div class="fl"></div>
                        <div class="fl">
