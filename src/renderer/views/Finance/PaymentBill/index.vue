  ...
  <div class="app-container data-list">
    ...
    <search-panel
      ...
      <template slot="more">
        <div class="clearfix">
          <el-form-item label="门店" prop="FullID" class="form-item-sm">
            <!--<el-select v-model="FormPaymentData.FullID" placeholder="请选择">-->
              <!--<el-option-->
      ...
      <template slot="button">
        ...
        <el-button size="medium" @click="handleExport" v-setbtn:Export  :loading="downloadLoading" type="primary">导出</el-button>
    ...
    <div class="panel data-list-table"   v-else>
      <el-table
        ...
        class="table-normal"
        border fit highlight-current-row>
        <el-table-column align="center" fixed="left" prop="PaymentData" label="日期" min-width="120">
          <template slot-scope="scope">
            <span>{{$dateFormat(scope.row.PaymentData)}}</span>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      CommonExport(Interface, textName) {
        Interface({
          ...
          FullID: this.FormPaymentData.FullID,
