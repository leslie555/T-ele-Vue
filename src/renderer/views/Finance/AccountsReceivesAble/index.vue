  ...
  <div class="app-container data-list">
    ...
    <div class="panel content-container">
      ...
      >
        ...
        <el-table-column align="center" prop="UnPaidMoney" label="未收金额" min-width="90">
          <template slot-scope="scope">
            <span>{{$priceFormat(scope.row.UnPaidMoney)}}</span>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="ReceivableDate" label="应收日期" min-width="80">
          <template slot-scope="scope">
    ...
    methods: {
      ...
      GetTabeledata(pages) {
        ...
        return GetReceivesAbleList({
          ...
          console.log(reponse)
          if (reponse) {
            this.ReceivesListDatas = reponse.Data.rows
